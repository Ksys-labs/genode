...
#ifndef __MUX44XX__IO_H__
#define __MUX44XX__IO_H__
 ...
 */
struct omap_mux {
	Genode::uint16_t	reg_offset;
	Genode::uint16_t	gpio;
	const char	*muxnames[OMAP_MUX_NR_MODES];
...
#define _OMAP4_MUXENTRY(M0, g, m0, m1, m2, m3, m4, m5, m6, m7)	\
	omap_mux(\
	(Genode::uint16_t)OMAP4_CTRL_MODULE_PAD_##M0##_OFFSET, \
	(Genode::uint16_t)g, \
	(const char*)m0, \
	(const char*)m1, \
	(const char*)m2, \
...
extern struct omap_mux omap4_core_muxmodes[];
extern struct omap_mux omap4_es2_core_subset[];
extern struct omap_mux omap4_wkup_muxmodes[];
